...
const Sidebar = ({ t }) => { //Componente para barra lateral
    ...
    return (
        <div className="sidebar"> {/**Div para barra lateral */}
            ...
            <SidebarLink link="./assets/certificates/react_basic_certificate.pdf" deployed={deployed} index={3} firstText={t('sidebar.coursesCertifications.reactBasic.firstText')} secondText={t('sidebar.coursesCertifications.reactBasic.secondText')} thirdText={t('sidebar.coursesCertifications.reactBasic.thirdText')} />
